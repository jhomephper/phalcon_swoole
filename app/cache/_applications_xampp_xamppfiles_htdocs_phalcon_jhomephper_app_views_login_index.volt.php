...
<title>Phalcon  Demo管理系统 - 系统登陆</title>
...
<div class="main_box">
	...
	<div class="login_box">
        ...
        <div class="login_form">
    		...
    		<form action="?_url=/login/login" id="login_form" method="post">
	...
	<div class="bottom">Copyright &copy; 2015 - 2016 <a href="#">Phalcon  Demo管理系统 - 系统登陆</a></div>
</div>
